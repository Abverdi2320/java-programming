...
public class MultiDArrayExample {
    public static void main(String[] args) {
        ...
        users[0][0] = "Abbas Verdiyev";
        users[0][1] = "AbbasBaku123";
        ...
        String[][] userData = {{"Abbas Verdiev" , "AbbasBaku123"}, {"Anna Ziyayeva", "AnnaAlmaty123"},{"Parvin Altae","ParvinVienna321"}};
